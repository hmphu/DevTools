...
require github.com/wailsapp/wails/v2 v2.0.0-beta.22
...
// replace github.com/wailsapp/wails/v2 v2.0.0-beta.22 => /Users/hmphu/go/pkg/mod/github.com/wailsapp/wails/v2@v2.0.0-beta.22
